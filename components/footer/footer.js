...
<footer className="p-4 bg-white sm:p-6 dark:bg-gray-900">
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
            <a href="https://flowbite.com/" className="flex items-center">
                <Image src={logo} className="mr-3 h-8" alt="FlowBite Logo" width={100}/>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <p href="https://flowbite.com/" className="hover:underline">Digitize™</p>All Rights Reserved.
        </span>
